...
the average estimate of mu\_hat is not equal to true value of mu, since
. But when true mu is so large that the null hypothesis is always
rejected, the average estimate of mu\_hat is approximately equal to true
value of mu.
